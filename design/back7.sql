...
insert  into `mf_cart`(`cart_no`,`user_no`,`case_no`,`qty`,`active`,`ordered_date`,`created_date`) values (4,4,3,1,'Y',NULL,'2014-08-23 23:10:35'),(5,4,2,1,'Y',NULL,'2014-08-23 23:10:29');
...
insert  into `mf_order`(`order_no`,`user_no`,`comment`,`status`,`active`,`created_date`) values ('123456',1,'测试描述','closed','Y','2014-07-31 21:59:06'),('234567',3,'描述2','paid','Y','2014-07-30 22:03:48');
...
insert  into `site_parameter_item`(`param_item_id`,`param_key`,`param_item_value`,`param_item_value1`,`param_item_value2`,`param_item_value3`,`param_item_name`,`param_item_comment`) values (1,'FUN_URL','http://www.163d.com',NULL,NULL,NULL,'URL','FUN相册链接'),(2,'EMAIL_API','smtp.163.com',NULL,NULL,NULL,'HOST','服务器'),(3,'EMAIL_API','25',NULL,NULL,NULL,'PORT','端口'),(4,'EMAIL_API','colormefun@163.com',NULL,NULL,NULL,'USERNAME','用户名'),(5,'EMAIL_API','4testuser',NULL,NULL,NULL,'PASSWORD','密码'),(7,'EMAIL_API','SMTP',NULL,NULL,NULL,'PROTOCOL','发送协议'),(8,'EMAIL_API','',NULL,NULL,NULL,'CC','抄送'),(9,'EMAIL_API','',NULL,NULL,NULL,'BCC','密送'),(11,'EMAIL_API','colormefun@163.com',NULL,NULL,NULL,'FROM','发件人'),(12,'SMS_API','http://utf8.sms.webchinese.cn',NULL,NULL,NULL,'API','接口地址'),(13,'SMS_API','colormefun',NULL,NULL,NULL,'UID','用户名'),(14,'SMS_API','68a2eb316e847a8c669e',NULL,NULL,NULL,'KEY','密码短信'),(15,'SMS_TEMP','您本次操作的验证码是：${validateCode}，请勿将验证码告诉他人。',NULL,NULL,NULL,'VALIDATE_CODE','验证码');
