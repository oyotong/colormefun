...
function OnSearch(form){
	form.action = "${ROOT }/admin/content/searchMarquee.do";
}
function OnUpdate(form,id) {
	form.action = "${ROOT }/admin/content/editMarquee.do?cids="+id;
}
function OnDelete(form,id) {
	if(window.confirm("确定要删除该滚动图片吗？")){
		form.action = "${ROOT }/admin/content/removeMarquee.do?cids="+id;
	}
}
...
<input name="content.contentType" type="hidden" value="marquee" />
<div id="Panel1" style="width:100%;">
	        
        <table cellpadding="3" cellspacing="1" class="tableborder1">           
            <tr>
                <td colspan="4" class="titlebg">
                    <span id="Label5">滚动图片列表</span></td>
            </tr>
            <tr>
                <td class="tablebody1" width="15%">
                    <span id="Label6">链接地址</span>：</td>
                <td class="tablebody1" colspan="3" width="85%">
                	<input name="content.subTitle" type="text" value="${content.subTitle }" style="width: 300px"  maxlength="200" id="subTitle" />
                </td> 
            </tr>
            <tr>
                <td class="tablebody1" width="15%">
                    <span id="Label16">图片描述</span>：</td>
                <td class="tablebody1" colspan="3" width="85%">
                    <input name="content.content" type="text" value="${content.content }" style="width: 300px"  maxlength="200" id="content" />
                </td>
            </tr>
            <tr>
                <td class="tablebody1">
	...
	<table class="blueGrid" cellspacing="1" cellpadding="3" border="0" id="GridView1">
		<tr class="Gridhead" style="font-weight:normal;font-style:normal;">
			<th scope="col">序号</th><th scope="col">图片</th><th scope="col">链接地址</th><th scope="col">发布时间</th><th scope="col">发布人</th><th scope="col">是否显示</th><th scope="col">显示顺序</th><th scope="col">功能</th>
		</tr>
		...
		<tr class="Griditem" onmouseout="this.style.backgroundColor='White';this.style.color='RoyalBlue'" onmouseover="this.style.backgroundColor='#fffdd7';this.style.color='#008fc3'" style="Cursor:hand">
           ...
           <a href="${ROOT }/admin/content/editMarquee.do?cids=${n.id}" >
               <img height="50px" width="100px" src="${ROOT}${n.pic1 }" />
           </a>

            <td><span title="${n.subTitle }">${mf:substring(n.subTitle,40) }</span></td>
