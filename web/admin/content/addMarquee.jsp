...
<body>
<m:message></m:message>
<form name="form1" method="post" enctype="multipart/form-data" action="${ROOT}/admin/content/saveMarquee.do?random=${mf:random()}" id="form1">
    <input name="content.id" type="hidden" value="${content.id }" id="id" />
    <input name="content.title" type="hidden" value="滚动图片" maxlength="100" id="content_title" />
    <input name="content.contentType" type="hidden" value="marquee" />
        <table cellpadding="3" cellspacing="1" class="tableborder1">
            ...
            <tr>
                ...
                <td class="tablebody1" colspan="3"><span id="lblpic"
                    ...
                    <m:imgUp name="content.pic1" maxHeight="50" maxWidth="100" value="${content.pic1 }" id="content_pic1" upname="image1"/></td>
            </tr>
            <tr>
                <td class="tablebody1" width="15%">
                    <span id="Label1">链接地址</span>：</td>
                <td class="tablebody1" colspan="3" width="85%">
                    <input name="content.subTitle" type="text" value="${content.subTitle }" style="width: 300px"  maxlength="100" id="content_subTitle" />
                </td>
            </tr>
            <tr>
                <td class="tablebody1">
                    <span id="Label6">图片描述</span>：</td>
                <td class="tablebody1" colspan="3">
                <fck:editor instanceName="content.content" basePath="/admin/js/Fckeditor" height="200">
        ...
        <span id="Label11" style="color:Red;">1、发布滚动图片</span>
        </form>
</body>
</html>
