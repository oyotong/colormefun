    ...
    <input name="user.userNo" type="hidden" value="${user.userNo }" id="user_userNo" />
        <table cellpadding="3" cellspacing="1" class="tableborder1">
            ...
            <tr>
                ...
                <td class="tablebody1">
                    <m:time name="user.registeredDate" value="${empty user.registeredDate?mf:sysdate():user.registeredDate }" id="user_registeredDate"></m:time>
                </td>
            </tr>
            <tr>
        ...
        <input type="submit" name="btnUpdata" value="添加客户" onmouseout="this.className='button_mouseout'" /><br />
        <span id="lblDisplay"></span></div>
        <br />
        <span id="Label20" style="color:Red;">操作说明：</span>&nbsp;<br />
        
        <span id="Label21" style="color:Red;">1、添加客户</span>
        </form>
</body>
</html>
