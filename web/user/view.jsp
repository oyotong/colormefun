...
<div class="page-content">
    <div class="main-content">
        ...
        <form name="partyForm" id="partyForm" action="" onsubmit="return false;" class="field-form">
            ...
            <table class="field-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input name="mfCase.kidsNum" disabled type="text" value="${mfCase.kidsNum }" size="25" id="mfCase_kidsNum" /></td>
                    </tr>
                    </c:if>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p>
                                <label><input type="radio" disabled value="N"${mfCase.needLocation ne 'N'?' checked="checked"':'' } name="mfCase.needLocation" /> 否，我们自己安排活动场所</label></p>
